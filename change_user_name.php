...
$description = "${intervalDays}日後に開発エンジニアになるちひろです!!｜新人コーダー1年目(2022.4.1 ~) 今日で${elapsedDays}日目!!｜業務はhtml/CSS/JavaScript/WordPress ゴリゴリ｜プログラミング学習中｜勉強する → React, Laravel, sql｜好き → 散歩🐾お肉🍖お寿司🍣";
